...
% See also this study (actual study behind paywall): https://www.cancer.gov/news-events/press-releases/2024/cancer-deaths-averted-prevention-screening-contribution
    ...
    % Compare in scale: 1.2 million deaths from covid since 2019, and taking out smoking 1.3 million deaths were averted by cancer prevention and screening --- over the _45_ year period from 1970-2020. That is to say, if we could have kept covid deaths to 100k, we would have saved the same number of people in a year or two as prevention and screening of cancer had... over 45 years. This fact can be seen as evidence of just how deadly covid was (compared to _cancer_ --- the second leading cause of death). But it could also be seen as evidence of just how much public health fucked up the response to covid. Or it can be seen as evidence of how much effort has gone into addressing cancer over the last half century for a payoff that is relatively small (after you remove smoking cessation).  
